...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-[60px] bg-transparent backdrop-blur-sm flex justify-between gap-x-6 sm:gap-x-10 items-center px-6 sm:px-10 border-[1px] border-solid border-[rgba(255,255,255,.3)] mb-5">
      <a href="/">
      ...
      <ul className="hidden sm:flex gap-x-10 items-center font-bold text-white">
        ...
        <li className="uppercase">
          <a href="http://tovanhuong.id.vn">My Blog</a>
        </li>
      </ul>
